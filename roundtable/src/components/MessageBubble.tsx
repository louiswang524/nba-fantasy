    ...
    return (
      <div className="mt-6 animate-fade-in-up">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-slate-400 text-sm font-medium px-2">📋 Discussion Summary</span>
          <div className="h-px flex-1 bg-white/10" />
        </div>
        <div className="bg-gradient-to-br from-slate-700/40 to-slate-800/40 border border-white/10 rounded-2xl p-5">
